...
Signal=/u/temp/signal1.txt                            # Localization of the directory where signal is stored and name of the signal.
ReportFile=/u/release/ReportFile.txt                  # File containing the progress of the shell.
Location=/u/product_directory/product1.CATProduct     # Directory where the CATProduct or the .psn are stored.

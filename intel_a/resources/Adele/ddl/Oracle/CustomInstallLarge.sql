...
CREATE TABLESPACE SCM_TBS2
  DATAFILE '&3./scm_tbs2.dbf' SIZE 114696K  AUTOEXTEND ON NEXT 57344K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 7160K
  SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE SCM_TBS3
  DATAFILE '&3./scm_tbs3.dbf' SIZE 655368K  AUTOEXTEND ON NEXT 327680K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 65536K
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TABLESPACE SCM_IDX2
  DATAFILE '&4./scm_idx2.dbf' SIZE 360456K  AUTOEXTEND ON NEXT 180224K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 7160K
  SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE SCM_IDX3
  DATAFILE '&4./scm_idx3.dbf' SIZE 2228232K  AUTOEXTEND ON NEXT 1114112K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 65536K
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TEMPORARY TABLESPACE SCM_TMP
  TEMPFILE '&5./scm_tmp.dbf' SIZE 30M
  REUSE AUTOEXTEND ON NEXT 50M MAXSIZE 1000M;

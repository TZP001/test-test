...
<!--Style Sheet to Convert XML file to Busy Time Bar Chart-->
<!--
	...
	displays the Busy Time of the Resources selected.
-->
...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/2000/svg"
  ...
  <!-- Getting the Busy Time Color from the Color Param input variable-->
	    ...
	    <g id="barChart" class="legend" style="text-anchor:start" stroke="none" clip-rule="evenodd" 
	      ...
	      <g id="GridAndLegend" style="stroke:none;">
		      <g stroke="black">
		        ...
		        <text stroke="black" font-size="20" transform="translate(30,-10)">Bar Chart for Busy Time</text>
		      ...
		      <text transform="translate(0 ,{$chartHeight + 15})  rotate(-90)">Busy Time in Seconds</text>
  ...
  <xsl:template name="Resource">
    ...
    <xsl:comment>========ENTERING RESOURCE TEMPLATE!!! ========</xsl:comment>

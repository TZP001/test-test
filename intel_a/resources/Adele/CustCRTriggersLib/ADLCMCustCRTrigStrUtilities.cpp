#include "ADLCMCustCRTrigStrUtilities.h"
...
void ADLCMCustCRTrigStrUtilities::ExtractExtensionFromFileName(
	const char *FileName,
	char *&RootName,
	char *&Extension,
...
const char *ADLCMCustCRTrigStrUtilities::LookupOne(const char *Name, const char *NameArray[], int Size)
{
...
const char *ADLCMCustCRTrigStrUtilities::LookupOneNoCase(const char *Name, const char *NameArray[], int Size)
{
	for (int Cnt1 = 0; Cnt1 < Size; Cnt1++)
	{
...
char *ADLCMCustCRTrigStrUtilities::ConcatStrings(
...
int ADLCMCustCRTrigStrUtilities::CompareNoCase(const char *String1, const char *String2)
{
#ifdef _WINDOWS_SOURCE
...
void ADLCMCustCRTrigStrUtilities::ExtractOneField(
	const char *String,
	...
	char *&Field)
{
	...
	ADL_ASSERT(pC2 != NULL && Cnt1 == (NumField -1), "String format is invalid, the " << NumField << "th field cannot be reached in " << String)

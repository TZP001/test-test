...
# Launch migration for Tubing models only
# === The environment variable MIGRATION_MASTER_APPLI is set to blank
# === to cause the non-AEC style of migration to be executed.
export MIGRATION_MASTER_APPLI=
export MIGRATION_INTERFACE=CATIAecMigration

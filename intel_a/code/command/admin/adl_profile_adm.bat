...
call "%ADL_DIFF_PATH%\CodeRef\%ADL_SITE_NAME%\%OSDS%\code\bin\ADLCopyLocal.exe" "%ADL_DIFF_PATH%\CodeRef\%ADL_SITE_NAME%" "%ADL_DIFF_LOCAL_PATH%\CodeRef\%ADL_SITE_NAME%" Date_Diff_Adele
...
echo ADL_DIFF_LOCAL=%ADL_DIFF_LOCAL%
...
rem * PATH 
rem ----------------------------------------------
set ADL_ADMIN_PATH=%ADL_PATH%\code\command\admin
set ADL_USER_PATH=%ADL_PATH%\code\command

set PATH=%PATH%;%ADL_USER_PATH%;%ADL_ADMIN_PATH%

rem ----------------------------------------------
rem Clean current user's log
echo User log cleaner started
call "%ADL_ADMIN_PATH%\adl_clean_log" 7

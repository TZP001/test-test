...
Help()
{
    ...
    echo ' '
    echo '    '$SHELLNAME' -h'
    echo '    '$SHELLNAME' [-env file -direnv dir] [-installdir dir] V4LineModel'
    echo ' '
...
if [ $LINEIDMODELFOUND -ne 1 ]
then
    echo 'ERROR!! V4 Model was not specified!'
    Help 1
fi
...
# Launch migration
$WSOSCODEBIN/CNEXT $V5ENV $V5ENVFILE $V5DIRENV $V5DIRENVPATH -batch -e CATAecV4ToV5LineIDs $LINEIDMODEL 2>&1

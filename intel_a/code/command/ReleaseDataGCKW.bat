...
call "%RELEASEMANAGER_PATH%\code\bin\ReleaseData.exe" -get %1 -key %2 -mode noduplicate -wait -type set -file "%RELEASEMANAGER_TMP%\ReleaseData-%RELEASEDATA_NUMBER%.bat"

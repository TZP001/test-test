...
call StdMKMKCommand -hostname localhost:1570 -trame settingsWODBNT -ITPort %ITEnoviaSitePort% -ITServer %ITEnoviaSiteServer% -n settings -silent -noSettingsCreation %*

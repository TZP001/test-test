...
rem Launch migration for Tubing models only
rem === The environment variable MIGRATION_MASTER_APPLI is set to blank
rem === to cause the non-AEC style of migration to be executed.
set MIGRATION_MASTER_APPLI=
set MIGRATION_INTERFACE=CATIAecMigration
...
:HELP
echo.
echo AEC BATCH MIGRATION of V4 Tubing Models
echo    This batch program migrates V4 Tubing models.
echo.
echo Usage:
echo.
echo    %BATCHNAME% -h
...
echo
echo    To migrate V4 tubing models to V5 Tubing Design, you must use a

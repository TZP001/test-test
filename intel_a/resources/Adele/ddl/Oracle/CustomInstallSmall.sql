...
CREATE TABLESPACE SCM_TBS2
  DATAFILE '&3./scm_tbs2.dbf' SIZE 15368K  AUTOEXTEND ON NEXT 7680K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 960K
  SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE SCM_TBS3
  DATAFILE '&3./scm_tbs3.dbf' SIZE 92168K  AUTOEXTEND ON NEXT 46080K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 9216K
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TABLESPACE SCM_IDX2
  DATAFILE '&4./scm_idx2.dbf' SIZE 46088K  AUTOEXTEND ON NEXT 23040K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 960K
  SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE SCM_IDX3
  DATAFILE '&4./scm_idx3.dbf' SIZE 276488K  AUTOEXTEND ON NEXT 138240K
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 9216K
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TEMPORARY TABLESPACE SCM_TMP
  TEMPFILE '&5./scm_tmp.dbf' SIZE 2M
  REUSE AUTOEXTEND ON NEXT 5M MAXSIZE 150M;
